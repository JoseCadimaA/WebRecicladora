        ...
        <div class="modal-dialog">
            <div class="modal-content bg-success">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="ProductosList">Almacenes del Producto</label>
                        <asp:DropDownList runat="server" CssClass="form-control" ID="AlmacenList" DataSourceID="AlmacenObjectDataSource" DataTextField="descripcion" DataValueField="almacenId">
                        </asp:DropDownList>
                        <asp:ObjectDataSource runat="server" ID="AlmacenObjectDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAlmacenesByProductoId" TypeName="AlmacenDSTableAdapters.AlmacenTableAdapter">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="ProductoIdHD" PropertyName="Value" DefaultValue="0" Name="intProductoID" Type="Int32"></asp:ControlParameter>
                            </SelectParameters>
                        </asp:ObjectDataSource>
                    </div>
                    <div class="row">
